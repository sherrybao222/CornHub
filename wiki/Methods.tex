...
$F_i$ is the free energy and $T_i$ is the transition state energy. From position $i-1$ to $i$, we can get the relationship between reaction rate constant and free energy:
\begin{equation}
